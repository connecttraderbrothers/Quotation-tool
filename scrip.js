...
function previewQuote() {
    ...
    // Header
    previewHtml += '<div class="header">';
    previewHtml += '<div class="company-info">';
    previewHtml += '<div class="company-name">TRADER <span class="highlight">BROTHERS</span> LTD</div>';
    ...
    previewHtml += '<img class="logo" src="https://github.com/infotraderbrothers-lgtm/traderbrothers-assets-logo/blob/main/Trader%20Brothers.png?raw=true" alt="Trader Brothers Logo">';
    previewHtml += '</div></div>';

    // Estimate Banner
    previewHtml += '<div class="estimate-banner">ESTIMATE</div>';

    // Info Section
    previewHtml += '<div class="info-section">';
    previewHtml += '<div class="client-info">';
    previewHtml += '<h3>Estimate for</h3>';
    previewHtml += '<p><strong>' + clientName + '</strong></p>';
    previewHtml += '<p>' + projectName + '</p>';
    previewHtml += '<p>' + projectAddress + '</p>';
    if (clientPhone) previewHtml += '<p>' + clientPhone + '</p>';
    previewHtml += '</div>';
    ...
    previewHtml += '<tr><td class="detail-label">Customer ID</td><td class="detail-value">' + customerId + '</td></tr>';
    previewHtml += '<tr><td class="detail-label">Expiry date</td><td class="detail-value"><span class="expiry-date">' + expiryDate + '</span></td></tr>';
    previewHtml += '</table>';
    previewHtml += '</div></div>';
    ...
    for (var category in categories) {
        previewHtml += '<tr class="section-header-row">';
        previewHtml += '<td colspan="4">' + category + '</td>';
        previewHtml += '</tr>';
    ...
    previewHtml += '<li>Deposit of ' + depositPercent + '% is required to secure start date</li>';
    previewHtml += '<li>Extra works to be charged accordingly</li>';
    ...
    previewHtml += '<div class="total-row-preview subtotal">';
    previewHtml += '<span>Subtotal</span><span>£' + subtotal.toFixed(2) + '</span>';
    previewHtml += '</div>';
    previewHtml += '<div class="total-row-preview vat">';
    previewHtml += '<span>VAT</span><span>£' + vat.toFixed(2) + '</span>';
    previewHtml += '</div>';
    previewHtml += '<div class="total-row-preview final">';
    previewHtml += '<span>TOTAL</span><span>£' + total.toFixed(2) + '</span>';
    previewHtml += '</div>';
    previewHtml += '</div></div>';
    ...
    previewHtml += 'traderbrotherslimited@gmail.com or 07979309957';
    previewHtml += '<div class="thank-you">Thank you for your business</div>';
    previewHtml += '</div>';

    document.getElementById('estimateContainer').innerHTML = previewHtml;
